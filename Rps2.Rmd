...
* Read it into R using `chi.flights <- read_csv("data.csv")` and use the bind_rows command to stitch together the monthly files into a yearlong file.
    ...
    + Warning: `setwd()` does not work inside of Rmd chunks. See <**this post**>[link](http://pbahr.github.io/tips/2016/04/16/fix_rmarkdown_working_directory_issue) for an alternative solution.
